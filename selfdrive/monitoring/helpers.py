...
class DRIVER_MONITOR_SETTINGS:
  def __init__(self, device_type):
    ...
    self._AWARENESS_TIME = 999. # passive wheeltouch total timeout   CHANGED FROM 30 TO 90 TO 999
    self._AWARENESS_PRE_TIME_TILL_TERMINAL =777.                 #   CHANGED FROM 15 TO 45 TO 777
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 222.             #   CHANGED FROM  6 TO 18 TO 222
    self._DISTRACTED_TIME = 999. # active monitoring total timeout   CHANGED FROM 11 TO 99 TO 999
    self._DISTRACTED_PRE_TIME_TILL_TERMINAL = 777.               #   CHANGED FROM  8 TO 72 TO 777
    self._DISTRACTED_PROMPT_TIME_TILL_TERMINAL = 222.            #   CHANGED FROM  6 TO 54 TO 222
